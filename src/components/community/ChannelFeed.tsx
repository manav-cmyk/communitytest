      ...
      {!channel.isAdminOnly && isJoined && (
        <div className="px-4 pt-3 pb-1">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl bg-background border-2 border-primary/60 hover:border-primary hover:bg-primary/5 transition-all shadow-sm text-left group"
          >
